class MuralsCatalogue extends HTMLElement {
    ...
    constructor(){
        ...
        this.template = `
            <section class="catalogue">
                <img class="w-full" src="./public/images/catalogues/murals/intro.png" alt="3D murals">                        
                    ...
                    <div class="flex flex-1 items-center justify-between">
                        ...
                        <div>
                            <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                                ...
                                <a id="link_1" class="relative inline-flex items-center px-4 py-2 text-sm font-semibold focus:z-20 text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-offset-0" href="3dmural_1.html" aria-current="page">1</a>
                                <a id="link_2" class="relative inline-flex items-center px-4 py-2 text-sm font-semibold focus:z-20 text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-offset-0" href="3dmural_2.html">2</a>
                                <a id="link_3" class="relative inline-flex items-center px-4 py-2 text-sm font-semibold focus:z-20 text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-offset-0" href="3dmural_3.html">3</a>
    ...
    loadCatalogue(){
        ...
        if(this.pagination == 1){
            ...
            previousBtns.setAttribute('href','3dmural_3.html');
            nextBtns.setAttribute('href','3dmural_2.html');
        }
        if(this.pagination == 2){
            link_2.classList = focusClassList;
            previousBtns.setAttribute('href','3dmural_1.html');
            nextBtns.setAttribute('href','3dmural_3.html');
        }
        if(this.pagination == 3){
            link_3.classList = focusClassList;
            previousBtns.setAttribute('href','3dmural_2.html');
            nextBtns.setAttribute('href','3dmural_1.html');
        }
                
    }

    createCatalogueImage(fileName){
        let url = `./public/images/catalogues/murals/${fileName}.png`;
        const img = document.createElement('img');
        img.classList = 'w-full';
        img.setAttribute('src',url);
        img.setAttribute('alt','3D murals wallpaper');
        return img;
    }
}

customElements.define('murals-catalogue',MuralsCatalogue);