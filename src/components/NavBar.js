        ...
        <header class= "bg-white">
            ...
            <div class="flex lg:flex-1">
                <a href="#" class="-m-1.5 p-1.5">
                    ...
                    <img class="h-8 w-auto border-solid border-2 rounded-full border-red-600" src="../public/images/india.png" alt="BM Wall">
                </a>
                </div>
                <div class="flex lg:hidden"> 
                <button id="hamburger" type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
                ...
                x-id="['dropdown-button']" class="relative">
                    ...
                    Our Services
                    <svg class="h-5 w-5 flex-none text-gray-400 chevron" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                            <i class="fa-solid fa-mosquito-net fa-shake fa-xl group-hover:text-indigo-600""></i>                            
                        ...
                        <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
                        <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                        <i class="fa-regular fa-image fa-xl group-hover:text-indigo-600"></i>
                        ...
                        <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
                        <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                            <i class="fa-solid fa-brush fa-xl group-hover:text-indigo-600"></i>
                ...
                <a href="#category" class="text-sm font-semibold leading-6 text-gray-900">Collections</a>
