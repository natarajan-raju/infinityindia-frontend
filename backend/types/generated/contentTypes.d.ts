...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    phone: Attribute.String &
      ...
      Attribute.DefaultTo<'1234567890'>;
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    items: Attribute.Relation<
      ...
      'api::item.item'
    >;
    price_per_sqft: Attribute.Decimal &
      Attribute.Required &
...
export interface ApiItemItem extends Schema.CollectionType {
  ...
  attributes: {
    itemInfo: Attribute.Component<'item-info.item-info'> & Attribute.Required;
...
export interface ApiPaymentPayment extends Schema.CollectionType {
  ...
  attributes: {
    bank_ref: Attribute.String & Attribute.Unique;
    amount: Attribute.Decimal & Attribute.Required & Attribute.DefaultTo<0>;
    ...
    > &
      Attribute.Required;
    status: Attribute.Enumeration<['success', 'pending', 'failure']> &
      Attribute.Required &
